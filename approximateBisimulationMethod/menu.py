...
class Menu:
    ...
    def print_menu(self):
        ...
        print("5. Set the IEEE 34 system (order = 310)")
        print("6. Set the IEEE 18 system (order = 141)")
        print("7. Set the IEEE 7 system (order = 51)")
        print("8. Set the IEEE 5 system (order = 37)")
